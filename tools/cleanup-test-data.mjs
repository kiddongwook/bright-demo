...
const { data: acs } = await admin.from('academies').select('id, slug').or('slug.like.a-%,slug.like.b-%,slug.like.otp-%,slug.like.flow-%,slug.like.outbox-%,slug.like.manage-%,slug.like.export-%,slug.like.hk-%,slug.like.onb-%,slug.like.files-%,slug.like.push-%,slug.like.inv-%,slug.like.bill-%,slug.like.seam-%,slug.like.hard-%,slug.like.rt-%,slug.like.ns-%,slug.like.attnote-%');
let users = 0;
for (const a of acs ?? []) {
