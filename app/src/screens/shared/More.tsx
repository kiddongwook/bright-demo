...
export function MoreSimple() {
  const { active, memberships, pick, logout, isOperator, enterOperator } = useSession(); const nav = useNav();
  ...
  return (
    <section className="view on">
      ...
      <div className="box">
        ...
        {isOperator && <button className="rw" onClick={enterOperator}><span className="bd"><span className="t">BRIGHT 운영자로 보기</span><span className="s">학원 만들기 · 초대 링크 · 잠금</span></span><span className="go">›</span></button>}
