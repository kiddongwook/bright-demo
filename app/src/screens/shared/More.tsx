  ...
  return (
    <section className="view on">
      ...
      <div className="box">
        ...
        <button className="rw" onClick={() => nav.push('prefs')}><span className="bd"><span className="t">알림 설정</span><span className="s">공지 · 답변 · 출결 카톡을 끄고 켜요</span></span><span className="go">›</span></button>
      </div>
