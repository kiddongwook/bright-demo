...
export default defineConfig({
  ...
  plugins: [react(), VitePWA({ registerType: 'prompt', workbox: { navigateFallbackDenylist: [/^\/functions\//], importScripts: ['push-sw.js'] }, manifest: { name: '영어의 집', short_name: '영어의 집', lang: 'ko', display: 'standalone', start_url: '.', scope: '.', background_color: '#FFFFFF', theme_color: '#2F5BEA', icons: [{ src: 'logo/icon-192.png', sizes: '192x192', type: 'image/png' }, { src: 'logo/icon-512.png', sizes: '512x512', type: 'image/png' }] } })],
